var helicopterImg, bgImg,itemImg;
...
function setup() {
	...
	packageSprite=createSprite(width/2,70,200,200);
	packageSprite.addImage(itemImg)
	...
	packageBody = Bodies.circle(width/2 , 100 , 20 , {restitution:0.1, isStatic:true});
